---
title: "Transformada de Lorentz general por generadores de grupo"
...
Deseamos una aplicación lineal $A$ que tome componentes $x_i$ y las mande las componentes  $x^\prime_i$
...
Siendo $V$ un espacio vecotorial Minkowski existe un isomorfismo $\overline{g}$ entre el $V$ y su dual $V^\ast$ $\overline{g}: V \to V^\ast$ tal que si tomamos las bases canónicas de ambas se cumple la siguiente relación
...
Por lo cual la transformación queda de la siguiente manera
